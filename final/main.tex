...
\begin{equation}
PUE = (P_UPS_input + P_fans + P_pumps + P_chiller + P_other) / P_IT
\end{equation}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{plots/avgmf}
	\caption{Thermal Model}
	\label{fig:avgmf}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{plots/avgin}
	\caption{Thermal Model}
	\label{fig:avgin}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{plots/avgout}
	\caption{Thermal Model}
	\label{fig:avgout}
\end{figure}
